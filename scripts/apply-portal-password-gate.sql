...
-- Fixes: "Could not find the 'must_change_password' column of 'portal_users' in the schema cache"
-- After running, go to Settings > API and reload the schema cache if the error persists.
...
-- Tell PostgREST to reload schema cache so the new column is visible immediately.
